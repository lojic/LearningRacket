...
(define (part n)
  (~> (iterate ; Iterate a simulation step function n times
       ...
       (foldl
        ...
        ;; Initial value for fold - a vector of zeros
        (make-vector 9 0)
      ...
      vector-sum)) ; Sum the vector result of iterating the simulation
